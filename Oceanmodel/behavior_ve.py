...
def behavior_move_ocean(timestep: int, oceanholders: dict, veaccounts: dict, minlock: int, maxlock: int) -> Dict[int, list(float, int, str)]:
    ...
    return {acting_agents, (ocean_amounts, durations, veaccounts)}